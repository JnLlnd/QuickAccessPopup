...
this["DialogSameLocartionExistsPrompt"] := "The following favorite has the same location."
this["DialogSameLocartionExistsQuestion"] := "Do you still want to add the new favorite?"
