...
this["GuiAddSnippetAndHotstring"] := "Add Snippet and Hotstring"
this["GuiAddSnippetAndHotstringDescription"] := "Create a Snippet favorite and its Hotstring trigger in the same dialog box. If the Windows Clipboard contains text, it is used for default values."
this["GuiAddSnippetAndHotstringTitle"] := "Add Snippet and Hotstring - ~1~ ~2~"
