...
this["AboutText2"] := "~1~ is written by Jean Lalonde using the`n<a href=""http://ahkscript.org/"">AutoHotkey</a> programming language.`n`nGerman translation: Edgar ""Fast Edi"" Hoffmann`nFrench translation: Jean Lalonde`nItalian translation: Riccardo Leone`nSpanish translation: kiketrucker (looking for new translator)`nBrazilian Portuguese translation: Igor Ruckert`nSimplified Chinese translation: ilaoyao`nPortuguese translation: Luis Neves`nDutch translation: Ric Roggeveen`nKorean translation: Maeng Bong Kyun`nRussian translation: Wylek.ru`nEnglish proof checking: (help welcomed)`n`nIcons by: <a href=""https://icons8.com/"">Icons8</a>`nInstall program: <a href=""http://www.jrsoftware.org/isinfo.php"">Inno Setup</a> by jrsoftware.org`nAutoHotkey_L v~2~ sources: <a href=""https://github.com/JnLlnd/QuickAccessPopup"">GitHub</a>"
...
this["ControlToolTipNextMenu"] := "Return to next menu"
this["ControlToolTipOpenMenuContainingSearchItem"] := "Open the submenu or group containing the selected favorite"
...
this["ControlToolTipShowContainerInGui"] := "Show a menu with favorites in the Customize window"
this["ControlToolTipSortFavorites"] := "Sort all or selected favorites in list"
this["ControlToolTipSortSearchResult"] := "Sort favorites in search result"
...
this["DialogDialogBoxes"] := "Dialog boxes"
...
this["DialogFavoriteFolderLiveHideExtensions"] := "File extensions"
this["DialogFavoriteFolderLiveHideIcons"] := "Icons"
this["DialogFavoriteFolderLiveHideInMenu"] := "Hide in menus"
...
this["DialogFavoriteFolderLiveRefreshManual"] := "Refresh this Live Folder menu only with the command`n""~1~"""
...
this["DialogFavoriteHidden"] := "Hide this favorite"
...
this["DialogIconsSelectPrompt"] := "Click an icon to select it."
this["DialogIconsSelectTitle"] := "Select Icon - ~1~ ~2~"
this["DialogInputExample"] := "Input Example"
this["DialogInputParameter"] := "Input parameter - ~1~"
...
this["DialogMenuSortEditMenu"] := "Edit this menu"
this["DialogMenuSortEnable"] := "Sort menu automatically"
this["DialogMenuSortFavoriteName"] := "Favorite name"
this["DialogMenuSortHeaderAutomatic"] := "Sort menu automatically by..."
this["DialogMenuSortHeaderFiltered"] := "Sort Search result by..."
this["DialogMenuSortHeaderMainMenu"] := "Sort Main menu by..."
this["DialogMenuSortHeaderManual"] := "Sort menu manually by..."
this["DialogMenuSortHeaderSearch"] := "Sort search result by..."
this["DialogMenuSortLastModified"] := "Modified date"
this["DialogMenuSortLastUsed"] := "Last used date"
this["DialogMenuSortSettingsOptions"] := "Customize Window Options"
this["DialogMenuSortUsage"] := "Usage"
...
this["DialogOK"] := "OK"
this["DialogOn"] := "On"
this["DialogOpenSubFolderAccessed"] := "accessed"
this["DialogOpenSubFolderCreated"] := "created"
this["DialogOpenSubFolderEnable"] := "Open a sub folder automatically"
this["DialogOpenSubFolderLabel"] := "Select the folder to open:"
this["DialogOpenSubFolderModified"] := "modified"
this["DialogOpenSubFolderMostAnciently"] := "the most anciently"
this["DialogOpenSubFolderMostRecently"] := "the most recently"
...
this["DialogSameLocartionExistsPrompt"] := "The following favorite has the same content:"
...
this["DialogSelectFolder"] := "Select Folder"
this["DialogSelectIcon"] := "Change icon"
this["DialogSelectIconJL"] := "Select in:"
...
this["GuiHotkeysHelp"] := "Customize Window Shortcuts Help"
...
this["GuiLvFavoritesHeaderFilteredDates"] := "Last Modified|Created"
this["GuiLvFavoritesHeaderFilteredStats"] := "Last Used|Usage"
this["GuiMove"] := "Move"
this["GuiMultipleAdd"] := "Add Multiple Favorites"
this["GuiMultipleAddDescription"] := "Add multiple favorites from a folder, from the list of running applications, etc. to the submenu of your choice in one click."
this["GuiMultipleAddFilter"] := "Filter"
this["GuiMultipleAddIntro"] := "1) Select a destination menu, choose a source and filter the favorites if desired.`n2) Select the favorites to add and click ""Add"".`nTo edit the name of a favorite select its row and press F2. To sort the list, click column headers."
...
this["GuiQuickAddNewSnippet"] := "this new snippet"
this["GuiQuickAddSnippet"] := "Snippet Quick Add"
this["GuiQuickAddSnippetDescription"] := "Quickly create a Snippet favorite and its Hotstring trigger in the same dialog box. If the Windows Clipboard contains text, it is used for default values. Use the regular ""Edit Favorite"" dialog box to set more advanced options."
this["GuiQuickAddSnippetExample"] := "Type ~1~ in a text editor to expand it."
this["GuiQuickAddSnippetExampleName"] := "Snippet Example"
this["GuiQuickAddSnippetTitle"] := "Snippet Quick Add - ~1~ ~2~"
...
this["MenuComputerManagement"] := "Computer Management"
this["MenuContainerInGui"] := "Favorites in Customize window"
this["MenuContainerInGuiDescription"] := "Show a menu with the favorites displayed in the Customize window, including when it contains a search result. In search results, duplicate menu names are appended with the ""[!]"" suffix to make them unique."
...
this["MenuDiskManagement"] := "Disk Management"
...
this["MenuEventViewer"] := "Event Viewer"
...
this["MenuMySnippetsMenu"] := "My Snippets"
...
this["MenuOpenBackupDirectory"] := "Open QAP Settings Backup Folder"
this["MenuOpenWorkingDirectory"] := "Open QAP Settings Folder"
...
this["MenuSearchOrder"] := "Original search order"
...
this["MenuTaskManager"] := "Task Manager"
...
this["MenuWindowAlwaysonTop"] := "Window Always on Top"
this["MenuWindowAlwaysonTopDescription"] := "Set the current window ""Always on Top"" property on or off (toggle)"
...
this["OopsAlternativeMenuModifiersDuplicates"] := "The Alternative Menu Modifier ""~1~"" is used twice.`n`nPlease make sure each modifier is used only once."
this["OopsAlternativeNotSupported"] := "The Alternative menu command ""~1~"" is not supported for favorites of type ""~2~""."
...
this["OopsCannotMoveToSelf"] := "You cannot move favorites to their current location. Please select another destination."
...
this["OopsContainerInGui"] := "The dynamic menu ""~1~"" can only be inserted in menu: ~2~"
...
this["OopsMenuSorted"] := "This command cannot be executed because this menu is sorted automatically."
...
this["OopsSortOnHiddenColumns"] := "You selected a sort criteria for a column that is not currently displayed in the ""Customize"" window.`n`nYou should enable the ""~1~"" option in ""Options, Customize Window"" and enable the QAP database in ""Options, Database""."
this["OopsTitle"] := "~1~ (~2~)"
...
this["OopsWorkingFolderDisabled"] := "You can't change the Settings Folder when the command-line parameter ""/Working:"" is used."
...
this["OptionsAlternativeMenuResetModifiers"] := "Reset default modifiers"
this["OptionsAlternativeMenuShowNotification"] := "Show Notification when using Alternative Menu"
this["OptionsAlternativeModifiers"] := "Modifiers"
...
this["OptionsExclusionMouseList"] := "Blacklist"
this["OptionsExclusionMouseListDescription"] := "Mouse trigger [~1~] Blacklist or Whitelist"
this["OptionsExclusionMouseListDetail1"] := "Select if the mouse button can be used on any application window with exceptions (blacklist) or only on some applications (whitelist). To add an applications to the list, enter any part of the its window title. You can enter multiple applications, one per line. For example, to enter Chrome and Word, enter the following two lines:`n`nGoogle Chrome`nMicrosoft Word"
this["OptionsExclusionMouseListDetail2"] := "When the menu trigger is not allowed on an application, the [~1~] click is sent to the target window as if QAP was not running. You can also add applications by their class name or process name (EXE file name). Prefix the title or class with * (asterisk) to also exclude (blacklist only) the application's dialog boxes. More <a href=""~2~"">help</a>."
this["OptionsExclusionMouseListWhitelist"] := "Whitelist"
...
this["OptionsHotkeyRemindersFull"] := "Display full text"
this["OptionsHotkeyRemindersNo"] := "Do not display"
this["OptionsHotkeyRemindersPromptHotstrings"] := "Hotstring reminders in menu:"
this["OptionsHotkeyRemindersPromptShortcuts"] := "Shortcut reminders in menu:"
...
this["OptionsLanguageLabels"] := "English|French|German|Spanish|Brazilian Portuguese|Italian|Portuguese|Dutch|Korean|Simplified Chinese|Russian"
...
this["OptionsSearchFrom"] := "Search scope"
this["OptionsSearchFromCurrent"] := "Search from current menu or group"
this["OptionsSearchFromMain"] := "Always search from Main menu"
this["OptionsSearchResults"] := "Search Results"
this["OptionsSearchWithLocale"] := "Search using locale language settings (e.g. ""é"" considered as ""e"")"
this["OptionsSearchWithStats"] := "Display dates and stats columns in Favorites list and Search results"
...
this["SponsorRemove"] := "Remove sponsor code"
this["SponsorRemoved"] := "Sponsor code removed"
