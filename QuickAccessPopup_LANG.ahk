...
this["OopsSortOnHiddenColumns"] := "You select a sort criteria for a column that is not currently displayed in the ""Customize"" window.`n`nYou should enable the ""~1~"" option in ""Options, Customize Window"" and enable the QAP database in ""Options, Database""."
this["OopsTitle"] := "~1~ (~2~)"
